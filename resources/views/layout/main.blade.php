...
<!-- Mirrored from portotheme.com/html/molla/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jul 2024 18:45:21 GMT -->
<!-- Added by HTTrack -->
                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('login') }}"><i class="icon-user"></i> Login</a>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="{{route('home')}}" class="logo">
                            <img src="{{asset('uploads/logo/lg.jpg')}}" alt="Molla Logo" width="105" height="25">
                        </a>
                    ...
                    <div class="header-right">
                        <div class="togosubmit" style="display: flex;">
                        <form id="searchForm" action="{{ route('search') }}" method="post">
                            ...
                            <a href="#" style="border: 1px solid orange; height:40px; width: 70px;" class="search-toggle" role="button" title="Search" id="submitLink">
                                <i class="icon-search"></i>
                            </a>
                           
                        </div>

                        <div class="dropdown cart-dropdown" style="margin-top: -25px;">
                            @if (Auth::user())
                            <a href="{{route('cart',Auth::user()->id)}}" class="dropdown-toggle" role="button" aria-haspopup="true" data-display="static">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{asset('uploads/product/'.$value->image)}}" alt="product" width="100px" height="100px">
                                            </a>
                                        </figure>
                                ...
                                <div class="dropdown-cart-total">
                                    ...
                                    <span class="cart-total-price">{{$value->total}}</span>
                                </div>

                                <div class="dropdown-cart-action">
                                    <a href="{{route('cart',Auth::user()->id)}}" class="btn btn-primary">View Cart</a>
                                    <a href="{{route('checkout',Auth::user()->id)}}" class="btn btn-outline-primary-2"><span>Checkout</span><i class="icon-long-arrow-right"></i></a>
                                </div>
                            </div>
                            @else
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="asset/images/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
...
<input type="email" class="form-control form-control-white" placeholder="Your Email Address" aria-label="Email Adress" required>
    ...
    <script src="{{ asset('asset/js/jquery.hoverIntent.min.js') }}"></script>
...
<!-- Mirrored from portotheme.com/html/molla/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jul 2024 18:46:37 GMT -->
