...
<!-- Mirrored from spacingtech.com/html/panno/panno-rtl/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jul 2024 18:09:47 GMT -->
...
<head>
        ...
        <!-- favicon -->
        <link rel="icon" type="image/x-icon" href="{{asset('img/favicon5.png')}}">
        <!-- bootstrap css -->
    ...
    <body>
                            ...
                            <div class="header-area">
                                <div class="header-element header-menu">
                                    ...
                                    <div class="mainmenu-content">
                                        <div class="main-wrap">
                                            <ul class="main-menu">
                                                <li class="menu-link">
                                                    <a href="index5.html" class="link-title">
                                                        <span class="sp-link-title">Home</span>
                                                    </a>
                                                </li>
                                                <li class="menu-link">
                                                    <a href="collection.html" class="link-title">
                                                        <span class="sp-link-title">Shop<span class="header-sale-lable">Sale</span></span>
                                                    </a>
                                ...
                                <div class="header-element header-logo">
                                    <div class="header-theme-logo">
                                        <a href="index5.html" class="theme-logo">
                                            <img src="{{asset('img/logo5.png')}}" class="img-fluid" alt="logo">
                                        </a>
                                    </div>
                                </div>
                                <div class="header-element header-icon">
                                    <div class="header-icon-block">
                                        <ul class="shop-element">
                                            <li class="side-wrap search-bar">
                                                <div class="search-content">
                                                    <div class="search-box">
                                                        <form action="https://spacingtech.com/search" method="get" class="search-crap">
                                                            <div class="form-search">
                                                                <input type="search" name="q" placeholder="Search product..." required="" class="search-input">
                                                                <button type="submit" class="search-btn"><span><i class="feather-search"></i></span></button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
        ...
        <!-- main start -->
       @yield('main');
       <!-- yield (nội dung thay đổi ) -->
        <!-- main end -->
        <!-- footer start -->
        <section class="footer-area bg-color section-ptb">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="footer-list">
                            <ul class="footer-ul">
                                            ...
                                            <ul class="ftcontact-ul collapse" id="footer-contact">
                                                <li class="ftcontact-li">
                                                    <div class="ft-contact-add">
                                                        <span class="info-icon"><i class="feather-map-pin"></i></span>
                                                        <div class="info-block">
                                                            <p>7266 Courtland st.</p><p>owings mills, md 12</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="ftcontact-li">
                                                    <div class="ft-contact-add">
                                                        <span class="info-icon"><i class="feather-mail"></i></span>
                                                        <div class="info-block">
                                                            <a href="tel(000)1234567890.html" title="tel:(000)1234567890" class="ft-contact-address">(000) 123 456 7890</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="ftcontact-li">
                                                    <div class="ft-contact-add">
                                                        <span class="info-icon"><i class="feather-phone-call"></i></span>
                                                        <div class="info-block">
                                    ...
                                    <ul class="ftlist-ul">
                                        <li class="ftlist-li">
                                            ...
                                            <ul class="ftlink-ul collapse" id="footer-extras">
                                                ...
                                                <li class="ftlink-li">
                                                    <a href="About-us-4.html">About us 2</a>
                                                </li>
                                                <li class="ftlink-li">
                                ...
                                <li class="footer-li footer-newslette">
                                    <ul class="ftlist-ul">
                                        <li class="ftlist-li">
                                            <h6 class="ftlist-title">Subscribe newsletter</h6>
                                            <a href="#" class="ftlist-title">
                                                    ...
                                                    <form method="post" id="contact_form" class="contact-form">
                                                        ...
                                                        <div class="subscribe-block">
                                                            ...
                                                            <div class="email-submit">
                                                                <button type="submit" class="btn" name="commit" id="Subscribe"><span class="btn-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1m17 4.238l-7.928 7.1L4 7.216V19h16zM4.511 5l7.55 6.662L19.502 5z"/></svg></span></button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                    ...
                    <div class="main-wrap">
                        <ul class="main-menu">
                            <li class="menu-link">
                                ...
                                <div class="menu-dropdown menu-single collapse zx" id="menu-single">
                                    <ul class="ul">
                                                            ...
                                                            <div class="single-product-wrap">
                                                                <div class="product-image">
                                                                    <a href="product-template.html" class="pro-img">
                                                                        <img class="img-fluid img1" src="{{asset('img/menu/home5-pro-banner1.jpg')}}" alt="menupro-1">
                                                                        <img class="img-fluid img2" src="{{asset('img/menu/home5-pro-banner2.jpg')}}" alt="menupro-2">
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <li class="menumegasup-li">
                                                        <div class="product-menu-list">
                                                            <div class="single-product-wrap">
                                                                <div class="product-image">
                                                                    <a href="product-template.html" class="pro-img">
                                                                        <img class="img-fluid img1" src="{{asset('img/menu/home5-pro-banner3.jpg')}}" alt="menupro-1">
                                                                        <img class="img-fluid img2" src="{{asset('img/menu/home5-pro-banner4.jpg')}}" alt="menupro-2">
                                                                    </a>
                                                                </div>
                                                                <div class="product-content">
                                                    ...
                                                    <li class="menumegasup-li">
                                                        <div class="product-menu-list">
                                                            <div class="single-product-wrap">
                                                                <div class="product-image">
                                                                    <a href="product-template.html" class="pro-img">
                                                                        <img class="img-fluid img1" src="{{asset('img/menu/home5-pro-banner5.jpg')}}" alt="menupro-1">
                                                                        <img class="img-fluid img2" src="{{asset('img/menu/home5-pro-banner6.jpg')}}" alt="menupro-2">
                                                                    </a>
                                                                </div>
                                                                <div class="product-content">
                                                                    <h6><a href="product-template.html">Watermelon cherries juice</a></h6>
                                                                    <div class="price-box">
                                                    ...
                                                    <li class="menumegasup-li">
                                                        <div class="product-menu-list">
                                                            <div class="single-product-wrap">
                                                                <div class="product-image">
                                                                    <a href="product-template.html" class="pro-img">
                                                                        <img class="img-fluid img1" src="{{asset('img/menu/home5-pro-banner7.jpg')}}" alt="menupro-1">
                                                                        <img class="img-fluid img2" src="{{asset('img/menu/home5-pro-banner8.jpg')}}" alt="menupro-2">
                                                                    </a>
                                                                </div>
                                                                <div class="product-content">
                                                                    <h6><a href="product-template.html">Apple avocado juice</a></h6>
                                ...
                                <div class="menu-dropdown menu-banner collapse" id="menu-shop-banner">
                                    <ul class="container ul p-0">
                                        <li class="menubanner-li">
                                            <div class="menubanner-img">
                                                <a href="collection.html" class="collection-img banner-hover">
                                                    <img src="{{asset('img/menu/home5-menu-banner1.jpg')}}"  class="img-fluid" alt="menu-banner1">
                                                </a>
                                        ...
                                        <li class="menubanner-li">
                                            <div class="menubanner-img">
                                                <a href="collection.html" class="collection-img banner-hover">
                                                    <img src="{{asset('img/menu/home5-menu-banner2.jpg')}}" class="img-fluid" alt="menu-banner2">
                                                </a>
                                                <a href="collection.html" class="collection-title">
                                                    <span>Cakes</span>
                                                </a>
                                        ...
                                        <li class="menubanner-li">
                                            <div class="menubanner-img">
                                                <a href="collection.html" class="collection-img banner-hover">
                                                    <img src="{{asset('img/menu/home5-menu-banner3.jpg')}}" class="img-fluid" alt="menu-banner3">
                                                </a>
                                                <a href="collection.html" class="collection-title">
                                                    <span>Bun</span>
                                                </a>
                                        ...
                                        <li class="menubanner-li">
                                            <div class="menubanner-img">
                                                <a href="collection.html" class="collection-img banner-hover">
                                                    <img src="{{asset('img/menu/home5-menu-banner4.jpg')}}" class="img-fluid" alt="menu-banner4">
                                                </a>
                                                <a href="collection.html" class="collection-title">
                                                    <span>Pastries</span>
                                                </a>
                        ...
                        <ul class="cart-items">
                                ...
                                <div class="cart-item-info">
                                    <div class="cart-item-image">
                                        <a href="javascript:void(0)">
                                            <img src="{{asset('img/cart/home5-cart1.jpg')}}" class="img-fluid" alt="cart-1">
                                        </a>
                                    </div>
                                    <div class="cart-item-details">
                                        <div class="cart-item-name">
                                            <a href="javascript:void(0)">Apple pineapple juice</a>
                                        </div>
                            ...
                            <li class="cart-item">
                                <div class="cart-item-info">
                                    <div class="cart-item-image">
                                        <a href="javascript:void(0)">
                                            <img src="{{asset('img/cart/home5-cart2.jpg')}}" class="img-fluid" alt="cart-2">
                                        </a>
                                    </div>
                                    <div class="cart-item-details">
                                        <div class="cart-item-name">
                                            <a href="javascript:void(0)">Apple avocado juice</a>
                                        </div>
                                        <div class="cart-pro-info">
                                            <div class="cart-qty-price">
                                                <span>1</span>
                            ...
                            <li class="cart-item">
                                <div class="cart-item-info">
                                    <div class="cart-item-image">
                                        <a href="javascript:void(0)">
                                            <img src="{{asset('img/cart/home5-cart3.jpg')}}" class="img-fluid" alt="cart-3">
                                        </a>
                                    </div>
                                    <div class="cart-item-details">
                                        <div class="cart-item-name">
                                            <a href="javascript:void(0)">Butternut carrot juice</a>
                                        </div>
                                        <div class="cart-pro-info">
                                            <div class="cart-qty-price">
                                                <span>1</span>
                            ...
                            <li class="cart-item">
                                <div class="cart-item-info">
                                    <div class="cart-item-image">
                                        <a href="javascript:void(0)">
                                            <img src="{{asset('img/cart/home5-cart4.jpg')}}" class="img-fluid" alt="cart-4">
                                        </a>
                                    </div>
                                    <div class="cart-item-details">
                                        <div class="cart-item-name">
                                            <a href="javascript:void(0)">Cacao banana juice</a>
                                        </div>
                                        <div class="cart-pro-info">
                                            <div class="cart-qty-price">
                                                <span>1</span>
                                ...
                                <div class="quick-view-tab">
                                    <div class="quick-block">
                                        <div class="quick-image">
                                            <a href="product-template.html"><img src="img/product/home5-pro-1.jpg" class="img-fluid" alt="p-1"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="quick-view-select">
                                            <div class="quick-view-text">
                                                <div class="selector-wrapper">
                                                    <label>Flavor:</label>
                                                    <select class="single-option-selector" data-option="option1" id="product-color1">
                                                ...
                                                <div class="selector-wrapper">
                                                    <label>Size:</label>
                                                    <select class="single-option-selector" data-option="option2" id="product-color2">
...
<!-- Mirrored from spacingtech.com/html/panno/panno-rtl/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jul 2024 18:12:30 GMT -->
</html>