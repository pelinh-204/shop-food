...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2024 07:22:33 GMT -->
<head>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('product.create')}}" class="nav-link" data-key="t-analytics"> Add Product</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('product.index')}}" class="nav-link" data-key="t-crm"> List Product</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('category.create')}}" class="nav-link"> <span data-key="t-file-manager">Add Category</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('category.index')}}" class="nav-link"> <span data-key="t-to-do">List CateGory</span></a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Variant</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarLayouts">
                                <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                        <a href="{{route('variant.index')}}" class="nav-link"> <span data-key="t-to-do">List Variant</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li> 
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarLanding">
                                <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                        <a href="{{route('banner.create')}}" class="nav-link" data-key="t-analytics"> Add Banner</a>
                                    </li>
                                    <li class="nav-item">
...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2024 07:23:38 GMT -->
</html>